                        ...
                        <div class="col-9">
                             <div class="card shadow">
                                 ...
                                 <div class="card-body">
                                     ...
                                     <form @submit="updatePage">
                                        <input type="hidden" name="pageId" v-model="formValues.pageId"/>
    ...
    export default {
        ...
        methods:{
            updatePage(event){
                ...
                axios.put("http://52.66.202.99:8080/api/admin/page/update",this.formValues)
                .then(resp=>{
        ...
        mounted(){
            ...
            axios.get("http://52.66.202.99:8080/api/admin/page/getbyid/"+id)
            .then(resp=>{
                this.formValues.pageName=resp.data.page.pageName
                this.formValues.pageId = resp.data.page._id
                this.formValues.pageHeaderImage = resp.data.page.pageHeaderImage
            })
