                             ...
                             <table class="table">
                                 ...
                                 <tbody>
                                     <tr v-for="(member,index) in members" v-bind:key="index">
                                         ...
                                         <td>{{member.email}}</td>
                                         <td>
                                            <a href="" v-on:click="DeletePageContent(member._id,index)">Delete</a> &nbsp;|&nbsp;                                            <!-- <router-link :to="{name:'Edit Member',params:{id:member._id}}" >Edit</router-link> &nbsp; -->
                                            <router-link :to="{name:'View Member',params:{id:member._id}}" >View</router-link>
                                         </td>
                                     </tr>
                                 </tbody>
                             </table>
...
<script>
    ...
    export default {
       ...
       methods:{
        ...
        mounted(){
            axios.get("http://52.66.202.99:8080/api/membership/list")
                .then(response=>{
