                                        ...
                                        <div class="row mt-3">
                                            <div class="col-12">
                                                <div class="form-group text-start">
                                                    ...
                                                    <input type="hidden" name="contentImage" v-model="formValues.projectImages" />
                                                    <div v-if="!!formValues.projectImages">
...
<script>
    ...
    export default {
        ...
        mounted(){
            ...
            axios.get("http://52.66.202.99:8080/api/admin/projects/getprojectbyid/"+id)
            .then(resp=>{
                console.log(resp.data.project.projectName)
                    this.formValues.projectId=resp.data.project._id
                    this.formValues.projectName=resp.data.project.projectName
                    this.formValues.categoryId=resp.data.project.categoryId
                    this.formValues.projectDesc=resp.data.project.projectDesc
                    this.formValues.projectImages=resp.data.project.projectImages
                    this.formValues.authNumber=resp.data.project.authNumber
                    this.formValues.dateStarted=resp.data.project.dateStarted
                    this.formValues.expectedDeliveryDate=resp.data.project.expectedDeliveryDate
                    this.formValues.projectLead=resp.data.project.projectLead
                    this.formValues.committeName=resp.data.project.committeName
                    this.formValues.projectLocation=resp.data.project.projectLocation
                    this.formValues.address=resp.data.project.address
                    this.formValues.localContactPerson=resp.data.project.localContactPerson,
                    this.formValues.localContactPhone=resp.data.project.localContactPhone
                    this.formValues.localContactEmail=resp.data.project.localContactEmail
                    this.formValues.budgetDoc=resp.data.project.budgetDoc
                    this.formValues.projectPlan=resp.data.project.projectPlan
                    this.formValues.otherDocs=resp.data.otherDocs
            })
        },
        methods:{
            ...
            updateProject(event){
                ...
                axios.put("http://52.66.202.99:8080/api/admin/projects/update",this.formValues)
                .then(resp=>{
